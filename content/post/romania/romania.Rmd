...
First, let's identify the testing and tested positive for covid-19 cases ratio. 
...
The data shows that the death ratio has been low in comparison to recovery. The highest death count was recorded in the month of August at 58. Meanwhile, in the month of July, the highest number of patients recovered were recorded at 1,707. There is no particular trend in the revered to death ratio, however, death count increased in August. You can look at it yourself by interacting with the month legend just double click on the month you want to select. 
...
The higher the stringency the more the measures taken to get the situation under control. With an increase in the number of cases, the Romanian Government implemented plans to implement to get control on the situation as mentioned in this [article](https://stirioficiale.ro/informatii/continuarea-masurile-de-prevenire-si-limitare-a-eventualelor-imbolnaviri-cu-noul-coronavirus). The stringency rate jumped from 16.67% to 58.33%, in March. Travel restrictions were imposed, as mentioned [here](https://stirioficiale.ro/informatii/comunicat-de-presa-20-martie-ora-9-36am). 
...
In May some relaxation measures were taken on the previous lockdown policy, as mentioned [here](https://stirioficiale.ro/informatii/informare-de-presa-9-mai-2020-ora-1-23-pm). Dropping the stringency index from 87.045 to 75%. 
...
The figure below shows the stringency index with the new cases reported, which lets us know the effectiveness of the Romanian Government. The figure speaks for itself during the initial spike the increase in the stringency level did control the new cases reported. However, cases spiked as soon as the regulations were relaxed which is to be expected. Overall the having a direct relation between the level of stringency and new cases reported. 
